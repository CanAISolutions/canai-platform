...
---
---
description: Guides system-wide performance optimization
globs: frontend/src/**/*.{ts,tsx}, backend/**/*.{js,ts}, databases/migrations/*.sql, .github/workflows/performance.yml
alwaysApply: true
---
...
## Purpose
Promote fast, scalable, and efficient performance for the CanAI Emotional Sovereignty Platform, supporting the 9-stage user journey while aligning with the Product Requirements Document (PRD).
